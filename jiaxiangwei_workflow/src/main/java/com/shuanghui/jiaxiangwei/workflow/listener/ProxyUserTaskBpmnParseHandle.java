package com.shuanghui.jiaxiangwei.workflow.listener;
 ...
 */
public class ProxyUserTaskBpmnParseHandle implements BpmnParseHandler {
    private static Logger logger= LoggerFactory.getLogger(ProxyUserTaskBpmnParseHandle.class);
    ...
    public void parse(BpmnParse bpmnParse, BaseElement baseElement){
        ...
        logger.debug("bpmnParse : {},userTsk : {}",bpmnParse,userTask);
